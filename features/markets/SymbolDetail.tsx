...
import { ArrowLeft, TrendingUp, PenTool, ArrowLeftRight, Brain, Plus, MessageCircle, Zap } from "lucide-react";
...
import { DecisionEngine } from "@/components/chart/DecisionEngine";
  ...
  return (
    <div className="space-y-3">
            ...
            {chartMode === "advanced" && (
              <>
                <button
                  ...
                  className="inline-flex items-center gap-1.5 rounded-lg bg-amber-500/15 px-3 py-1.5 text-xs font-semibold text-amber-400 transition-colors hover:bg-amber-500/25"
                >
      ...
      <DecisionEngine
        ...
        onOpenCoach={() => { setDecisionOpen(false); setCoachOpen(true); }}
